...
The Support group can be reached out to at [AstrakoBotSupport](https://t.me/AstrakoBotSupport), where you can ask for help about @AstrakoBot, discover/request new features, report bugs, and stay in the loop whenever a new update is available. 
...
Note: This instruction set is just a copy-paste from Marie, note that [AstrakoBotSupport](https://t.me/AstrakoBotSupport) aims to handle support for @AstrakoBot and not how to set up your own fork. If you find this bit confusing/tough to understand then we recommend you ask a dev, kindly avoid asking how to set up the bot instance in the support chat, it aims to help our own instance of the bot and not the forks.
